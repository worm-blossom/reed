...
\begin{tikzpicture}[xscale=1.2,yscale=1.4]%[font=\tiny]
    ...
    \begin{pgfonlayer}{main}
        \begin{scope}[transparency group, opacity=0.2]
			\draw[cPoolPath2,line width=15pt,rounded corners=0.1em,line cap=round] (v8_0.center) -- (v7_0.center) -- (v6_1.center) -- (v3_1.center) -- (v3_0.center) -- (v2_0.center);
			\draw[cPoolPath2,line width=15pt,rounded corners=1em,line cap=round] (v8_0.center) -- (v7_0.center) -- (v6_1.center) -- (v3_1.center) -- (v3_0.center) -- (v2_0.center);
		\end{scope}
	\end{pgfonlayer}
